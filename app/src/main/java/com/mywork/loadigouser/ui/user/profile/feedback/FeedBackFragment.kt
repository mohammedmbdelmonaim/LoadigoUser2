...
import com.mywork.loadigouser.databinding.FragmentAboutBinding
import com.mywork.loadigouser.databinding.FragmentCategoriesBinding
import com.mywork.loadigouser.databinding.FragmentFeedbackBinding
...
class FeedBackFragment : BaseFragment(){
    ...
    override fun onCreateView(
        ...
        _binding =
            DataBindingUtil.inflate(layoutInflater, R.layout.fragment_feedback, container, false)
        return binding.root
    }
...
//        lifecycleScope.launch { viewModel.getCategoriesByServiceId(args.service.id!!)}
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as UserActivity).binding.iHeader.tvTitle.text = getString(R.string.about)
