package com.mywork.loadigouser.ui.user.buy_pick_delivery
...
import com.mywork.loadigouser.databinding.FragmentBuyPickDeliveryBinding
...
class PickAndDeliveryFragment : BaseFragment() {
    private var _binding: FragmentBuyPickDeliveryBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding =
            DataBindingUtil.inflate(
                layoutInflater,
                R.layout.fragment_buy_pick_delivery,
                container,
                false
            )
        return binding.root
    ...
    override fun onResume() {
        ...
        binding.mcPick.setOnClickListener {
            val action =
                PickAndDeliveryFragmentDirections.actionBuyPickAndDeliveryFragmentToMapFragment(
        ...
        binding.btnContinue.setOnClickListener {
            when {
                ...
                user.deliveryLocation.isNullOrEmpty() -> {
                    ...
                    navController.navigate(R.id.action_buyPickAndDeliveryFragment_to_buyStepsFragment)
                }
            }
        }
    }
